...
<html lang="en">
  ...
  ?>
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <strong>Mehta Raj Hemantkumar</strong> with <span style="font-size:20px;color:red;">&hearts;</span>  <br> The Sparks Foundation</p>
      </footer>
